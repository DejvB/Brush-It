...
public class PlayerPowerUpHandler : MonoBehaviour
{
            ...
            case 2: //rubber
                foreach (GameObject player in Players)
                {
                    if (gameObject != player)
                    {
                        ...
                        player.GetComponent<PlayerController>().Color = Color.clear;
    ...
    void OnGUI()
    {
        ...
        for (int i = 0; i < keyCodes.Length; i++)
        {
            ...
            {
                GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerPowerUpHandler>().BeginEffect(i);
            }
        }
    }//*/
}
